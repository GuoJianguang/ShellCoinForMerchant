...
@interface IncomeView()<UITableViewDelegate,UITableViewDataSource>
...
- (instancetype)init
{
    self = [super init];
    if (self) {
        self = [[NSBundle mainBundle]loadNibNamed:@"IncomeView" owner:nil options:nil][0];
        self.tableView.backgroundColor  = [UIColor clearColor];
        self.backgroundColor = [UIColor clearColor];
        __weak IncomeView *weak_self = self;
